					...
					<div id="main">
						...
						<section>
							<ul class="posts">
								...
								<li>
									<article>
										<header>
											<h3><a href="{{ route('single_jobpost', ['post_id' => $post->id]) }}">{{ $post->title }}</a></h3>
											<time class="published" datetime="2015-10-20">{{ $post->created_at }}</time>
										</header>
										<a href="{{ route('single_jobpost', ['post_id' => $post->id]) }}" class="image"><img src="{{ asset('images/'.$post->image) }}" alt="{{ $post->title }}"/></a>
									</article>
								</li>
								@endforeach
							</br>
						...
						<!-- Post -->
							...
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="{{ route('single_jobpost', ['post_id' => $post->id])  }}">{{ $post->title }}</a></h2>
							<!--			<p>{{ $post->title }}</p> -->
									</div>
									<div class="meta">
								...
								<footer>
									<ul class="actions">
										<li><a href="{{ route('single_jobpost', ['post_id' => $post->id])  }}" class="button large">Continue Reading</a></li>
									</ul>
									<!--		<ul class="stats">
						...
						<!-- Post -->
						 @foreach($articles as $post)
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="{{ route('single_article', ['post_id' => $post->id])  }}">{{ $post->title }}</a></h2>
										<!--			<p>{{ $post->title }}</p> -->
									</div>
									<div class="meta">
								...
								<footer>
									<ul class="actions">
										<li><a href="{{ route('single_article', ['post_id' => $post->id])  }}" class="button large">Continue Reading</a></li>
									</ul>
								<!-- 	<ul class="stats">
										<li><a href="#">General</a></li>
										<li><a href="#" class="icon solid fa-heart">28</a></li>
