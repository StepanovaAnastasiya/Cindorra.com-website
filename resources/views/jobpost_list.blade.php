      ...
      <li>
        <article>
          <header>
            ...
            <ul class="actions">
          <a href="{{ route('edit_job_post_form', ['post_id' => $post->id]) }}" class="button large">Edit</a>
                           ...
                           @endif
                             ...
                             <div class="card-body">
                                 ...
                                 <form action="{{ route('delete_post', ['post_id' => $post->id]) }}" method="post"><br>
                                      {{ csrf_field() }}
                                      <button type="submit" name="submit" value="jobpost" class="btn btn-danger" >delete</button>
                                  </form>
                             </div>
                         </div>
                     </div>
